...
namespace SkyAirlines.UserControls
{
    public partial class AircraftShowroom : UserControl
    {
        ...
        public AircraftShowroom(string aircraft, string whoIsBuying)
        {
            InitializeComponent();
        ...
        private void AircraftShowroom_Load(object sender, EventArgs e)
        {
            ...
            if (whoIsBuying == "Airline")
            {
                if (aircraft == "Boeing")
                {
                    ...
                    // Price
                    dataGridView.Rows[0].Cells[5].Value = "7500";
                    dataGridView.Rows[1].Cells[5].Value = "12500";
                    dataGridView.Rows[2].Cells[5].Value = "35000";
                    dataGridView.Rows[3].Cells[5].Value = "15000";
                    dataGridView.Rows[4].Cells[5].Value = "15000";
                    dataGridView.Rows[5].Cells[5].Value = "20000";
                    dataGridView.Rows[6].Cells[5].Value = "20000";
                ...
                if (aircraft == "Airbus")
                {
                    ...
                    dataGridView.Rows[0].Cells[5].Value = "7500";
                    dataGridView.Rows[1].Cells[5].Value = "12500";
                    dataGridView.Rows[2].Cells[5].Value = "12500";
                    dataGridView.Rows[3].Cells[5].Value = "15000";
                    dataGridView.Rows[4].Cells[5].Value = "15000";
                    dataGridView.Rows[5].Cells[5].Value = "20000";
                    dataGridView.Rows[6].Cells[5].Value = "35000";
                ...
                if (aircraft == "CRJ")
                {
                    ...
                    // Price
                    dataGridView.Rows[0].Cells[5].Value = "10000";
                ...
                if (aircraft == "Antonov")
                {
                    ...
                    // Price
                    dataGridView.Rows[0].Cells[5].Value = "50000";
        ...
        private void btnBuyLicence_Click(object sender, EventArgs e)
        {
            if(whoIsBuying == "Pilot")
                ...
                licences.BuyLicenceAirline(aircraftShort, GlobalData.airlineID, int.Parse(lblPrice.Text));
